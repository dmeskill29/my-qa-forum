    ...
    <>
      ...
      <div data-custom-class="body">
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            >
              ...
              <bdt className="question">SolveCircle</bdt>
              <bdt className="block-component" />
              <bdt className="statement-end-if-in-editor" /> (
              <bdt className="block-component" />
            ...
            at <bdt className="question">121A South Roberson Street</bdt>
            <bdt className="block-component" />,{" "}
            <bdt className="question">Chapel Hill</bdt>
                ...
                <span style={{ fontSize: 15 }}>
                  <span data-custom-class="body_text">
                    <span style={{ color: "rgb(89, 89, 89)" }}>
                      ...
                      <bdt className="block-component" />
                      <bdt className="block-component" />{" "}
                      <bdt className="question">27516</bdt>
                      <bdt className="statement-end-if-in-editor" />
                    </span>
                  </span>
                </span>
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            >
              ...
              <span style={{ color: "rgb(0, 58, 250)" }}>
                <bdt className="question">solvecircle.app</bdt>
              </span>{" "}
          ...
          >
            <bdt className="question">
              SolveCircle is an online Q&amp;A platform where users can post and
              solve problems. The website uses both an internal point system,
              circle keys, and a point system that can be backed with monetary
              value, star keys. These keys can be added to a user&apos;s posts
              to incentive answers and would then be transferred to the user
              with the selected top answer for that post.{" "}
            </bdt>
          </div>
          <div
            className="MsoNormal"
          ...
          >
            ...
            >
              ...
              phone at <bdt className="question">8603065727</bdt>, email at{" "}
              <bdt className="question">d@solvecircle.app</bdt>
              <bdt className="block-component" />,
              <bdt className="statement-end-if-in-editor" /> or by mail to{" "}
              <bdt className="question">121A South Roberson Street</bdt>
              <bdt className="block-component" />,{" "}
              <bdt className="question">Chapel Hill</bdt>
              <bdt className="block-component" />
              <bdt className="block-component" />,{" "}
          ...
          >
            ...
            >
              ...
              &quot;<strong>you</strong>&quot;
              <bdt className="statement-end-if-in-editor" />
              ), and <bdt className="question">SolveCircle LLC</bdt>, concerning
          ...
          >
            ...
            >
              ...
              <bdt className="question">d@solvecircle.app</bdt>, as stated in
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            >
              ...
              <bdt className="question">d@solvecircle.app</bdt>. If we ever
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            <span style={{ fontSize: 15 }}>
              ...
              <bdt className="block-component" /> The length of your billing
              cycle <bdt className="block-component" />
              is monthly
              <bdt className="block-component" />.
              <bdt className="statement-end-if-in-editor" />
              <bdt className="else-block" />
          ...
          >
            <span style={{ fontSize: 15 }}>
              We offer a <bdt className="question">7</bdt>-day free trial to new
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              the Services or modifies, impairs, disrupts,
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            <span style={{ fontSize: 15 }}>
              ...
              <bdt className="question">Orange County</bdt>,{" "}
              <bdt className="statement-end-if-in-editor" />
              <bdt className="block-component" />
              <bdt className="question">North Carolina</bdt>
          ...
          >
            ...
            <bdt className="block-component" style={{ fontSize: 15 }} />{" "}
            <bdt className="question">Orange</bdt>
              ...
              <strong>
                <strong>
                  ...
                  >
                    <strong>
                      <bdt className="block-component" />
                      Phone: <bdt className="question">8603065727</bdt>
                      <bdt className="statement-end-if-in-editor" />
                    </strong>
                  </span>
                </strong>
