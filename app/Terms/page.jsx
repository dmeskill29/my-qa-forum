    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        <bdt className="question">
          ...
          solve problems. The website uses both an internal point system, circle
          keys, and a point system that can be backed with monetary value, star
          keys. These keys can be added to a user’s posts to incentive answers
          and would then be transferred to the user with the selected top answer
          for that post.{" "}
        </bdt>
      </div>
      <div
      ...
      >
        ...
        >
          ...
          <bdt className="question">d@solvecircle.app</bdt>, as stated in the
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          <bdt className="question">d@solvecircle.app</bdt>. If we ever grant
