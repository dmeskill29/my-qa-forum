...
const ProfileMenu = ({ session }) => {
  ...
  return (
    <div className="relative flex items-center" ref={wrapperRef}>
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="origin-top-right absolute right-0 mt-36 py-1 w-32 bg-white rounded-md shadow-lg z-20 border border-gray-200 transition-opacity duration-200 ease-linear">
          {/* User Profile Link */}
          <Link
